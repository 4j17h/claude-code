...
check_file "$REPO_ROOT/docs/execution-modes.md"
...
check_file "$REPO_ROOT/scripts/claude-batch-commit-mode.sh"
check_file "$REPO_ROOT/scripts/claude-batch-commit-mode.ps1"
check_file "$REPO_ROOT/scripts/claude-batch-isolated-mode.sh"
check_file "$REPO_ROOT/scripts/claude-batch-isolated-mode.ps1"
check_file "$REPO_ROOT/scripts/claude-batch-json-mode.sh"
check_file "$REPO_ROOT/scripts/claude-batch-json-mode.ps1"
check_file "$REPO_ROOT/scripts/claude-batch-stream-json-mode.sh"
check_file "$REPO_ROOT/scripts/claude-batch-stream-json-mode.ps1"
check_file "$REPO_ROOT/scripts/claude-budget-mode.sh"
check_file "$REPO_ROOT/scripts/claude-budget-mode.ps1"
check_file "$REPO_ROOT/scripts/claude-plan-mode.sh"
check_file "$REPO_ROOT/scripts/claude-plan-mode.ps1"
check_file "$REPO_ROOT/scripts/claude-autopilot-lite.sh"
check_file "$REPO_ROOT/scripts/claude-autopilot-lite.ps1"
check_file "$REPO_ROOT/scripts/claude-autopilot-worktree.sh"
check_file "$REPO_ROOT/scripts/claude-autopilot-worktree.ps1"
